 ...
 */
const deployHat: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  /*
  ...
  */
  ...
  // const Hat = await hre.ethers.getContract("Hat", deployer);
};

export default deployHat;

// Tags are useful if you have multiple deploy files and only want to run one of them.
// e.g. yarn deploy --tags Hat
deployHat.tags = ["Hat"];
