...
export default function TransactionDetails({ isVisible, onClose, tx }: Props) {
  ...
  const calcGasFee = () => {
    const estimatedGasFee =
      ethers.getBigInt(tx.gasUsed) * ethers.getBigInt(tx.gasPrice);
    return parseFloat(ethers.formatEther(estimatedGasFee).toString(), 5);
  };
  ...
  const calcTotalAmount = () => {
    ...
    return parseFloat(ethers.formatEther(totalAmount).toString(), 5);
  };
      ...
      <View style={styles.container}>
        ...
        <View style={styles.row}>
          <View>
            ...
            <Text variant="bodyLarge">{truncateAddress(tx.from)}</Text>
          </View>
        ...
        <View style={styles.row}>
          <View>
            ...
            <Text variant="bodyLarge">#{tx.nonce}</Text>
          </View>

          <View style={styles.alignRight}>
            <Text variant="labelMedium">Date</Text>
            <Text variant="bodyLarge">{renderTimestamp()}</Text>
          </View>
        </View>
        ...
        <View style={styles.detailsBox}>
          <View style={styles.row}>
            ...
            <Text variant="bodyLarge">
              {parseFloat(ethers.formatEther(ethers.getBigInt(tx.value)), 5)}{' '}
